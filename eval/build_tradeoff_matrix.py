...
with open("eval/results/finetuned_results (3).json") as f:
...
print(f"{'Avg Latency (ms)':<30}{baseline['avg_latency_ms']:<25}{finetuned['avg_latency_ms']:<25}")
print(f"{'Cost / 1k requests ($)':<30}{baseline['estimated_cost_per_1k_requests_usd']:<25}{finetuned['estimated_cost_per_1k_requests_usd']:<25}")


savings_pct = (
    (baseline['estimated_cost_per_1k_requests_usd'] - finetuned['estimated_cost_per_1k_requests_usd'])
